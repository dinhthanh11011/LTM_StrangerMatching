package com.example.StrangerMatching.Configuration.JWT;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        // only the Token
        if (requestTokenHeader != null && requestTokenHeader.startsWith("JWT_Token ")) {
            ...
            logger.warn("JWT Token does not begin with JWT_Token String");
        }
